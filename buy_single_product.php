<?php
    ...
    if (!isset($_SESSION["username_of_fashion_paradise"]) && !isset($_SESSION["cust_id_of_fashion_paradise"])) {
        ...
        $_SESSION["buy_product_you_selected"] = $fetch_pro_id = (int) $_REQUEST["buy_single_product"];
...
<body>
    <div class="login">
        ...
        <form action="buy_single_product.php?buy_single_product=<?php echo $fetch_pro_id; ?>" method="POST">
