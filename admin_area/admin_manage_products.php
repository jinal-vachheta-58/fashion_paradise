    ...
    <div class="container">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <?php
            echo '<a href="insert_product.php" class="bg-info p-3 py-2 border-0 mx-3 text-dark mb-4 insert" style="display: inline-block; text-decoration: none;">Insert New Product</a>';
             ?>   <form action="" method="post">
                    <table class="table table-bordered border-warning">
                        ...
                        <tbody>
                            ...
                            // $total = 0;
                            $cart_query = "SELECT * FROM products order by product_id desc ";
                                ...
                                $status = $row["status"];
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                ...
                                                <?php
                                                echo "
<a href='admin_edit_product.php?pro_id=$product_id' class='fun btn btn-secondary col-12 mb-2'>Edit </a>";
                                            ...
                                            <td >
                                                ...
                                                <?php
                                                echo "
<a href='admin_delete_product.php?pro_id=$product_id' class='fun btn btn-secondary col-12 mb-2'>Delete </a>";
