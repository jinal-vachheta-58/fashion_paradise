                ...
                <form action="" method="post">
                    <table class="table table-bordered border-warning">
                        ...
                        <tbody>
                            ...
                            <?php
                            global $con;
                            // $cust_id = $_SESSION["admin_of_fashion_paradise"];
                            // $total = 0;
                            $cart_query = "SELECT * FROM customer";
...
<tr>
    ...
    <th>See Order History</th>
                                ...
                                while ($row = mysqli_fetch_array($result_select_query)) {
                                    ...
                                    $select_order_count = "select count(*) as order_count from orders where cust_id = $cust_id";
                                    $result_order_count = mysqli_query($con, $select_order_count);
                                    if ($result_order_count) {
                                        $row = mysqli_fetch_assoc($result_order_count);
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php
                                            echo "
<a href='admin_see_details_of_cust_order.php?cust_id=$cust_id' class='fun btn btn-secondary col-12 mb-2'>Order Details </a>";
