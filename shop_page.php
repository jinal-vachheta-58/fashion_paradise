...
if(!isset($_SESSION['username_of_fashion_paradise']) && isset($_GET["add_to_cart"]))
{
    $_SESSION['item_to_be_added_to_cart'] = $_GET["add_to_cart"];
    header("location:login.php");
}
else if(!isset($_SESSION['username_of_fashion_paradise']) && isset($_GET["add_to_wishlist"]))
{
    $_SESSION['item_to_be_added_to_wishlist'] = $_GET["add_to_wishlist"];
    header("location:login.php");
}
else if(isset($_SESSION['username_of_fashion_paradise']) && isset($_SESSION['cust_id_of_fashion_paradise']) && isset($_GET["add_to_cart"]))
{
    // $_SESSION['item_to_be_added_to_cart'] = $_GET["add_to_cart"];
    // header("location:login.php");
}
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div class="row">
                    ...
                    <!-- Add pagination links after displaying products -->
...
// echo $a;
                    ...
                    // for($b= 1 ; $b <= $a ;$b++)
// {
//   echo "<a href='shop_page.php?page=".$b."'>  $b  </a>";
// }
                    ...
                    //     echo "<a href='shop_page.php?page=$i'>$i</a> ";
                    // }
                    ?>
                    <!-- </div> -->
