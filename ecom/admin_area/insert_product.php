...
if (($_SERVER["REQUEST_METHOD"]) == "POST") {
    ...
    if (isset($_POST["insert_product"])) {
        ...
        if (empty($_POST["product_title"]) || empty($_POST["description"]) || empty($_POST["product_keywords"]) || empty($_POST["product_category"]) || empty($_POST["product_price"]) || empty($_POST["product_image_name"])) 
        {
