        ...
        <div class="row bg-secondry">
            <div class="col-md-12  p-1 d-flex align-items-center">
                ...
                <div class="button text-center ">
                    ...
                    <button class="n-i bg-success"><a href="see_order_detail_of_delivery.php"
                            class="nav-link text-light  bg-success my-1">Manage orders</a></button>
                    <!-- <button class="n-i bg-success"><a href="d_p_list_of_orders.php"
                            class="nav-link text-light  bg-success my-1">List Of Orders</a></button> -->
