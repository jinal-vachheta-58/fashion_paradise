...
if (!isset($_SESSION["delivery_person_of_fashion_paradise"]) && !isset($_SESSION["delivery_person_id"])) {
    ...
    $delivery_person_of_fashion_paradise = $_SESSION["delivery_person_of_fashion_paradise"];
    $delivery_person_id = $_SESSION["delivery_person_id"];
}

// if (!isset($_GET["dp_orders_id"])) {

//     echo "<script> alert('Error in fetching delivery man.'); window.location.href = 'admin_manage_delivery_person.php'; </script>";
    ...
    <div class="bg-light">
        <h2 class="text-center p-2">
            ...
            if (isset($_SESSION["delivery_person_of_fashion_paradise"])) {
                echo " Welcome " . $_SESSION["delivery_person_of_fashion_paradise"] . "";
            } else {
                echo "Welcome devivery person";
            }
            ...
            <div id="hotbox">
                <div class="box">
                    <div class="shop_by_cat container bg-dark text-light">
                        <div class="col-md-12">
                            <h1> <?php echo $_SESSION["delivery_person_of_fashion_paradise"] . "'s all deliveries";   ?> </h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <form action="" method="post">
                    <table class="table table-bordered border-warning">
                        ...
                        <tbody>
                            ...
                            // $total = 0;
                            $order_query = "SELECT * FROM orders where dp_id = $delivery_person_id order by order_id desc ";
                            $result_select_query = mysqli_query($con, $order_query);
...
<?php
echo "
<a href='edit_order_status.php?see_order_details=$order_id' class='fun btn btn-secondary col-12 mb-2'>Edit order status </a>";
...
<?php
echo "
<a href='edit_payment_status.php?see_order_details=$order_id' class='fun btn btn-secondary col-12 mb-2'>Edit payment status</a>";
...
?>
                                            ...
                                            <td >
                                                ...
                                                <?php
                                                echo "
<a href='delivery_person_see_order_details.php?see_order_details=$order_id&cust_id=$cust_id' class='fun btn btn-secondary col-12 mb-2'>See Order Details </a>";
