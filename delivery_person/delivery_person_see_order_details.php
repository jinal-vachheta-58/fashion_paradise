...
if (!isset($_SESSION["delivery_person_of_fashion_paradise"]) && !isset($_SESSION["delivery_person_id"])) {
    ...
    echo "<script> alert('Please login so you can see order details.'); window.location.href = 'd_p_login.php'; </script>";
...
if (!isset($_GET["see_order_details"]) && !isset($_GET["cust_id"])) {
    ...
    echo "<script> alert('error in fetching order details.'); window.location.href = 'see_order_detail_of_delivery.php'; </script>";
    ...
    <div class="container">
        ...
        if (isset($_GET['see_order_details'])) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<div class='row'>";
                echo "<div class='col-2 border border-secondary rounded a'>";
                ...
                echo "<div class='col-3 border border-secondary f rounded'>";
                echo "<p class='mb-0 text-secondary'> Total Amount : </p>";
                echo "<h4>  Rs. " . $amt . " /-</h4>";
                echo "</div>";
                            ...
                            while ($rr = mysqli_fetch_assoc($result_query)) {
                                ...
                                while ($row = mysqli_fetch_assoc($result_select_query)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img class="cart_image" src="../admin_area/product_images/<?php echo $product_image; ?>"
                                                alt="product_image">
                                        </td>
                                        <td>
