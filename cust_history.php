                ...
                <form action="" method="post">
                    <table class="table table-bordered border-warning">
                        ...
                        <tbody>
                            ...
                            $cust_id = $_SESSION["cust_id_of_fashion_paradise"];
                            // $total = 0;
                            $cart_query = "SELECT * FROM orders where cust_id = $cust_id order by order_id desc ";
...
// }
                                        ...
                                        <tr>
                                            ...
                                            <td >
                                                ...
                                                <?php
                                                echo "
<a href='see_order_details.php?see_order_details=$order_id' class='fun btn btn-secondary col-12 mb-2'>See Order Details </a>";
