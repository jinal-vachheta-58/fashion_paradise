...
if (!isset($_SESSION["username_of_fashion_paradise"]) && !isset($_SESSION["cust_id_of_fashion_paradise"])) {
    ...
    echo "<script> alert('Please login so you can see your order history.'); window.location.href = 'login.php'; </script>";
...
echo "<div class='row'>";
    ...
    echo "<p class='mb-0 text-secondary'> Order Date : </p>";
    echo "<h4> " .$order_date." </h4>";
    echo "</div>";
        ...
        while ($row = mysqli_fetch_assoc($result_select_query)) {
            ...
            // $product_id = $row['product_id'];
                                ...
                                <td class="">
                                    ...
                                    <?php
                                    echo "
<a href='buy_single_product.php?buy_single_product=$product_id' class='fun btn btn-warning col-12 mb-2'>Buy it Again</a>";
                                ...
                                <td class="">
                                    ...
                                    <?php
                                    echo "
<a href='product_details.php?single_product_id=$product_id' class='fun btn btn-secondary col-12 mb-2'>Details</a>";
                                    ?>
                                </td>
                            </tr>
                        </tbody>
